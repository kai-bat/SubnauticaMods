...
namespace MinecraftFish.Creatures
{
    public static class FlopperFish
    {
        ...
        {
            GameObject mainGO = new GameObject("TropicalFlopper");
            mainGO.SetActive(false);
            GameObject modelPrefab = UnityEngine.Object.Instantiate(Plugin.bundle.LoadAsset<GameObject>("Assets/Prefabs/TropicalFlopperPrefab.prefab"));
