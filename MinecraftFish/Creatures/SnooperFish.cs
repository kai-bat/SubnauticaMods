...
{
    public static class SnooperFish
    {
        public static PrefabInfo Info = PrefabInfo.WithTechType("TropicalSnooperFish", "Snooper", "Colourful, blocky snooper")
            .WithIcon(ImageUtils.LoadSpriteFromFile(Plugin.modFolder + "tropical.png"));

        public static IEnumerator Register()
        {
            GameObject mainGO = new GameObject("TropicalSnooper");
            mainGO.SetActive(false);
            GameObject modelPrefab = UnityEngine.Object.Instantiate(Plugin.bundle.LoadAsset<GameObject>("Assets/Prefabs/TropicalSnooperPrefab.prefab"));
            ...
            mainGO.EnsureComponent<TropicalColours>();
